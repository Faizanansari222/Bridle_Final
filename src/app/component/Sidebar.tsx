    ...
    sideBarIcons: [
      {
        ...
        icon: (
          <svg
            className=" flex-shrink-0 text-xl  text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-[#ff4f9b] dark:group-hover:text-white"
      ...
      },
      {
        ...
        icon: (
            <svg
            className=" flex-shrink-0 text-xl text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-[#ff4f9b] dark:group-hover:text-white" xmlns="http://www.w3.org/2000/svg" width="1rem" height="1rem" viewBox="0 0 24 24"><path fill="currentColor" d="M11 11V3H5c-1.1 0-2 .9-2 2v6zm2 0h8V5c0-1.1-.9-2-2-2h-6zm-2 2H3v6c0 1.1.9 2 2 2h6zm2 0v8h6c1.1 0 2-.9 2-2v-6z"/></svg>
        ...
        icon: (
          ...
          >
            <path
              fill="currentColor"
              fillRule="evenodd"
              d="M4 2a.5.5 0 0 0-.447.276l-1.5 3A.5.5 0 0 0 2 5.5v2a.5.5 0 0 0 .5.5H3v5.5a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5V8h.5a.5.5 0 0 0 .5-.5v-2a.5.5 0 0 0-.053-.224l-1.5-3A.5.5 0 0 0 12 2zm9 3.618V7h-2V6h-1v1H8.5V6h-1v1H6V6H5v1H3V5.618L4.309 3h7.382zM6.5 10h1V9h-1zm2 0h1V9h-1zm-1 1.5h-1v-1h1zm1 0h1v-1h-1z"
              clipRule="evenodd"
            />
          </svg>
        ),
